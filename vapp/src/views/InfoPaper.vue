 ...
 * @LastEditTime: 2020-03-24 20:43:06
    ...
    <el-main>
      ...
      <el-card class="box-card">
        <div class="text item">
          ...
          <li>私钥与助记词为唯一有效凭证,请私人保管。</li>
          <li>TODO......</li>
          <!-- TODO按钮居中或者靠右  按钮点击倒计时-->
          <el-button style="bt-class" type="success" round @click="confirm">我已知晓</el-button>
        </div>
      </el-card>
    </el-main>
    <el-main v-if="secretVisible">
      <el-card class="box-card">
        <el-row>
          <el-col :span="6">
            <el-image :src="img" scale-down class="image"></el-image>
          </el-col>
          <el-col :span="16">
            <el-form ref="form" :model="form" label-width="60px" size="medium ">
              ...
              <el-form-item label="私钥">
                <el-input v-model="form.prikey"></el-input>
              </el-form-item>
              <el-form-item label="公钥">
                <el-input v-model="form.pubkey"></el-input>
              </el-form-item>
            </el-form>
            <!-- TODO 二维码位置 -->
          </el-col>
        ...
        <el-row>
          <el-button type="primary" icon="el-icon-download" round @click="download"></el-button>
          <el-button type="primary" round>进入主页</el-button>
        </el-row>
      </el-card>
    </el-main>
  </el-container>
