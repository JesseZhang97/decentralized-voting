 ...
 * @LastEditTime: 2020-03-24 01:17:13
  ...
  <div class="login" id="login">
    ...
    <div class="log-email">
      <input
        type="text"
        placeholder="帐号"
        :class="'log-input' + (userInfo.account==''?' log-input-empty':'')"
        v-model="userInfo.account"
      />
      <input
        type="password"
        placeholder="密码"
        :class="'log-input' + (userInfo.password==''?' log-input-empty':'')"
        v-model="userInfo.password"
      />
      <input
        type="text"
        placeholder="姓名"
        :class="'log-input' + (userInfo.name==''?' log-input-empty':'')"
        v-model="userInfo.name"
      />
      <input
        type="text"
        placeholder="所属组织"
        :class="'log-input' + (userInfo.organization==''?' log-input-empty':'')"
