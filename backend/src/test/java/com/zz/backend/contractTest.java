 ...
 * @Author: zhen
 * 
 * @LastEditTime: 2020-05-26 18:45:16
 * 
 * @Description:
 */
...
public class contractTest {
  ...
  public void emailTest() throws Exception {
    ...
    ml.setText("您好,\n你有一个新的可参与投票,投票活动名为：" + "福建工程学院广播电台技术部部长" + "\n可注册时间为:" + "2020-05-26 18:05" + "--"
        + "2020-05-26 18:15" + "\n可投票时间为:" + "2020-05-26 18:16" + "--" + "2020-05-26 18:30" + "\n投票地址为："
        + "0xf00ee906956a52cd65d3a2c4579d9b4601bd1a6c");
  ...
  public void reg() throws Exception {
    ...
    // DecVoting voting = DecVoting.load(contractAddress, web3j, credentials, new
    // DefaultGasProvider());
    // 获取投票人
  ...
  public void setupDataTest() throws Exception {
    ...
    // final BigInteger GAS_PRICE = BigInteger.valueOf(20000000000L); // L being
    // long; capital for clarity
    ...
    // get instance
    // DecVoting voting =
    // DecVoting.load("0xFbd4Ca99A4010870b69604Ffe12Ed8cF0B53F96A", web3j,
    // credentials, GAS_PRICE,
    // GAS_LIMIT);
    // 发起投票
